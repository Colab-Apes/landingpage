...
const Home = () => {
  return (
    <div className=" font-lato  bg-white ">
      <NavBarComp />
      <div className=" px-8 sm:px-10 lg:px-10 xl:px-10 mt-20 sm:mt-32  lg:mt-[9rem] xl:mt-[10rem]   ">
        ...
        <p className="text-left font-inter text-[#333] mt-4">
          ...
          <p className="text-left mt-4 text-sm sm:text-base lg:mt-4 ">
            Join Projects That Interests You And Be A Part Of Their Success
            Story
          </p>
        </p>
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 mt-4 sm:mt-20 lg:mt-0 xl:mt-8 gap-y-10 sm:gap-y-20 md:gap-x-20 sm:gap-x-10 md:gap-y-32 lg:gap-x-0 lg:gap-y-10  mx-auto justify-center w-full place-items-center">
