...
const NavBarComp = () => {
  return (
    <div>
      <nav className="font-lato  bg-white z-20 hidden  lg:flex justify-between items-center shadow-xl  fixed top-0  h-[8rem] w-full px-10">
        <a href="/">
          <img
            src={logo}
            alt=""
        ...
        <div className=" z-[20]  flex items-center gap-x-20 text-xl text-center mt-4">
          ...
          <p className=" text-[#33333380]  pb-4 cursor-pointer">
            Create project
          </p>
        </div>
