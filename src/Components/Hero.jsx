...
const Hero = () => {
  return (
    <div className="grid md:grid-cols-2 px-20 h-[75vh] justify-center items-center justify-items-center ">
      <div className="flex flex-col h-[30vh] justify-around">
        ...
        <p className="text-4xl text-main mt-4 font-bold leading-[1.5]">
