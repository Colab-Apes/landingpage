  ...
  return (
    <div className="grid lg:flex mt-4 lg:mt-0 xl:px-20 md:h-[75vh] lg:h-[80vh] sm:w-[33rem] md:w-[42rem] lg:w-full justify-center lg:gap-x-8 xl:gap-x-16 items-center justify-items-center">
      <div className="flex flex-col lg:min-h-[30vh] justify-between sm:justify-around">
        ...
        {/* Animated Text */}
        <TypeAnimation
          className="text-[1.5rem] leading-[1.6] text-left lg:leading-[3rem] w-full sm:w-[33rem] md:w-[40rem] lg:w-[30rem] h-[8rem] sm:h-[12.6rem] xl:leading-[3.6rem] sm:text-[1.9rem] md:text-4xl lg:text-[2rem] xl:text-[2.5rem] text-main mt-4 font-bold"
          sequence={[
